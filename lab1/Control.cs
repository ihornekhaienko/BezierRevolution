...
namespace lab1
{
    public class Control
    {
        ...
        public event MoveDel OnMove;

        #region INIT
        public Control(double x, double y, double z, BezierPatch bezier, MoveDel move, double radius = 0.05)
        {
        ...
        public Control(Point3D center, int i, int j, BezierPatch bezier, MoveDel move, double radius = 0.05)
        {
            this.center = center;
            this.radius = radius;
            this.i = i;
